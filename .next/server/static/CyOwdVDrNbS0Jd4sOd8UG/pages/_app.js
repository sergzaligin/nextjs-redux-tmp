...
const reducers = Object(external_redux_["combineReducers"])({
  testPage: test_reducer["a" /* default */]
});
const store = Object(external_redux_["createStore"])(reducers, {}, Object(external_redux_devtools_extension_["composeWithDevTools"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a)));
const isServer = true;
...
const with_redux_store_isServer = true;
const __NEXT_REDUX_STORE__ = '__NEXT_REDUX_STORE__';

function getOrCreateStore(initialState) {
  // Always make a new store if server, otherwise state is shared between requests
  if (with_redux_store_isServer) {
